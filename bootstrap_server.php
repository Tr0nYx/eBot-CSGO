...
if (PHP_OS == "Linux") {
    ...
    $webSocketProcess = proc_open('node ' . __DIR__ . '/websocket_server.js ' . \eBot\Config\Config::getInstance()->getBotIp() . ' ' . \eBot\Config\Config::getInstance()->getBotPort(), $descriptorspec, $pipes);
